...
'Define the static values for the headers, extend exisiting table  '
Range("i1").Value = "Ticker"
Range("j1").Value = "Yearly Change"
Range("k1").Value = "Percentage Change"
Range("l1").Value = "Total Stock Volume"

'Define the static values for the headers, new table '
...
'define / record the Ticker value, "first one" from the data set - set in  the current_value field'
current_value = Cells(2, 1).value

'store open value for the first Ticker in Open_Value field'
Open_value = Cells(2, 3).Value

'Set the CLosed_Value to 0, we will track this value in the following loop'
Closed_value = 0
